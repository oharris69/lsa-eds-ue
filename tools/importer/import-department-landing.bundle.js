...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-department-landing.js
  var import_department_landing_exports = {};
  __export(import_department_landing_exports, {
    default: () => import_department_landing_default
  });
  ...
  var import_department_landing_default = {
    transform: (payload) => {
      const {
        document: document2,
        url,
  ...
  return __toCommonJS(import_department_landing_exports);
})();
